...
public class GetOrderServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            OrderDTO savedOrder = orderDAO.getOrderById(orderId);
            List<OrderDetailDTO> detailOfOrder = orderDetailDAO.getDetailsOfOrder(orderId);
            PaymentDTO paymentDTO = paymentDAO.getPaymentByOrderId(orderId);
